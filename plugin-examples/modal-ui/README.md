...
See the [source reference](https://paseo.sh/docs/plugins/v0.8/reference#plugin-sources)
...
[host UI reference](https://paseo.sh/docs/plugins/v0.8/reference#host-ui) for the API contract.
